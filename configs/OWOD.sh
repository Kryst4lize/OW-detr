...
python -u main_open_world.py \
    ...
    --PREV_INTRODUCED_CLS 0 --CUR_INTRODUCED_CLS 20 --data_root '../../input/ow-detr-paper/data/OWOD' --train_set 't1_train' --test_set 'all_task_test' --num_classes 81 \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 2 \
    --PREV_INTRODUCED_CLS 20 --CUR_INTRODUCED_CLS 20 --data_root '../../input/ow-detr-paper/data/OWOD' --train_set 't2_train' --test_set 'all_task_test' --num_classes 81 \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 2 \
    --PREV_INTRODUCED_CLS 20 --CUR_INTRODUCED_CLS 20 --data_root '../../input/ow-detr-paper/data/OWOD' --train_set 't2_ft' --test_set 'all_task_test' --num_classes 81 \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 2 \
    --PREV_INTRODUCED_CLS 40 --CUR_INTRODUCED_CLS 20 --data_root '../../input/ow-detr-paper/data/OWOD' --train_set 't3_train' --test_set 'all_task_test' --num_classes 81 \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 2 \
    --PREV_INTRODUCED_CLS 40 --CUR_INTRODUCED_CLS 20 --data_root '../../input/ow-detr-paper/data/OWOD' --train_set 't3_ft' --test_set 'all_task_test' --num_classes 81 \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 2 \
    --PREV_INTRODUCED_CLS 60 --CUR_INTRODUCED_CLS 20 --data_root '../../input/ow-detr-paper/data/OWOD' --train_set 't4_train' --test_set 'all_task_test' --num_classes 81 \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --dataset owod --num_queries 100 --eval_every 2 \
    --PREV_INTRODUCED_CLS 60 --CUR_INTRODUCED_CLS 20 --data_root '../../input/ow-detr-paper/data/OWOD' --train_set 't4_ft' --test_set 'all_task_test' --num_classes 81 \
